  ...
  module Core
    ...
    module ProductFilters
      ...
      def self.price_filter
        ...
        conds = [[Spree.t(:under_price, price: format_price(300000)), v[:amount].lteq(300000)],
                 ["#{format_price(300000)} - #{format_price(350000)}", v[:amount].in(300000..350000)],
                 ["#{format_price(350000)} - #{format_price(500000)}", v[:amount].in(350000..500000)],
